...
import { FrontMatterEditor, FrontMatterData } from "./FrontMatterEditor";
import { useThemeContext } from "@/components/theme-provider";
import "@/assets/editor-theme.css"; // Import editor theme CSS from assets
...
export function NoteEditor({
  ...
  return (
    <div className="flex flex-col h-full p-4 pb-20">
      ...
      className={`text-sm ${isDarkMode ? 'mdx-dark-theme' : ''}`}
